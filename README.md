...
* Travel-time calculations: Uses a finite-difference eikonal solver following [Podvin et al., 1999](https://academic.oup.com/gji/article-lookup/doi/10.1111/j.1365-246X.1991.tb03461.x.). The implementation of the eikonal solver from [Podvin et al., 1999](https://academic.oup.com/gji/article-lookup/doi/10.1111/j.1365-246X.1991.tb03461.x.) used in this study is part of the software available at https://doi.org/10.5281/zenodo.11242981 or at https://github.com/andherit/invdfe. 
