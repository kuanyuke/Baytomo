...
c                 write (*,*) '!!! ERROR -- amplitude is not a number'
c		  write (*,*) '!!! Warning -- amplitude is not a number'
c                  write (*,*) 'Trace ',itr,' phase ',iph,' comp ',icomp
c                  write (*,*) 'Setting to zero, continuing.'
                  curamp(icomp)=0
                end if
              end do
